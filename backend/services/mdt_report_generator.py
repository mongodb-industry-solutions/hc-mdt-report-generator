...
class MDTReportGenerator:  
    ...
    def _format_patient_info(self, pat: Dict[str, Any]) -> str:
        ...
        field_labels = {
            ...
            'Tel': 'Phone',
            'Email': 'Email',
            'MedecinTraitant': 'Treating Physician',
            'NumeroSS': 'Social Security Number',
        }
                    ...
                    if text_content and len(text_content.strip()) >= 10:
                        chunked_doc = {
                            "metadata": {
                                ...
                                "filename": filename,
                                "report_type": "Complete Document",
                                "LIBNATCR": "Complete Document",
                                "CR_DATE": "",
                                "TITLE": "",
    ...
    async def _extract_entities(self, chunked_docs: List[Dict], reasoning_effort: Optional[str] = "high", ner_config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # Add programmatic "Presentation Date" as today's date
            today_date = datetime.now().strftime('%d/%m/%Y')
            presentation_date_entity = {
                "entity_name": "Presentation Date",
                ...
                "notes": "Date of presentation to MDT meeting (automatically generated)"
            }
            
            # Add to entities list
            all_entities.append(presentation_date_entity)
            logger.info(f"Added programmatic 'Presentation Date': {today_date}")
            
            final_results = {
                "disclaimer": "Generated by AI — not intended for clinical use.",
